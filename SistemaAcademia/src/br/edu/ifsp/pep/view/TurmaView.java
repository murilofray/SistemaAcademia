...
public class TurmaView extends javax.swing.JDialog {
    ...
    private void atualizarTabela() {
        ...
        for (Turma turmaa : turmas) {
            modelo.addRow(new Object[]{turmaa.getId(), turmaa.getNome(), turmaa.getModalidadeId(), turmaa.getCapacidadeMaxima(), turmaa.getHorarioInicio(), turmaa.getHorarioFim()});
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Modalidade", "Capacidade", "Hora Inicio", "Hora Fim"
            }
        ) {
        ...
        bIcone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifsp/pep/imagens/turma.png"))); // NOI18N
        bIcone.setBorder(null);
        bIcone.setBorderPainted(false);
        bIcone.setContentAreaFilled(false);
        bIcone.setDefaultCapable(false);
        bIcone.setFocusPainted(false);

        cbPesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome:", "Valor:" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(294, 294, 294)
                        .addComponent(lTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(281, 281, 281)
                        .addComponent(bIcone)))
    ...
    private void bInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInserirActionPerformed
        TurmaInserirView turmaInserirView = new TurmaInserirView();
        turmaInserirView.setVisible(true);
        turmas = turmaDAO.findAll();
        this.atualizarTabela();
    ...
    private void bAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAlterarActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            TurmaAlterarView turmaAlterarView = new TurmaAlterarView();
            turma = this.turmas.get(jTable1.getSelectedRow());
            turmaAlterarView.carregarDados(turma);
            turmaAlterarView.setVisible(true);
            turmas = turmaDAO.findAll();
            atualizarTabela();
        } else {
    ...
    private void bVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVisualizarActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            TurmaVisualizarView turmaVisualizarView = new TurmaVisualizarView();
            turma = this.turmas.get(jTable1.getSelectedRow());
            turmaVisualizarView.carregarDados(turma);
            turmaVisualizarView.setVisible(true);
        } else {
    ...
    private void bExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExcluirActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            ...
            if (JOptionPane.showOptionDialog(null, "Ao excluir a turma todas matriculas relacionadas a ela serão excluidas juntos, Clique em confirmar para continuar.", "Atenção", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]) == 0) {
    ...
    private void bPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPesquisaActionPerformed
        if (tfPesquisa.getText().equals("")) {
            ...
            if (cbPesquisa.getSelectedIndex() == 0) {
                turmas = turmaDAO.findByNome(tfPesquisa.getText());
            } else {
                if (cbPesquisa.getSelectedIndex() == 1) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Para pesquisar por id informe apenas numeros", "Atenção", JOptionPane.WARNING_MESSAGE);
                    }
                } else {
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Para pesquisar por valor informe apenas numeros e ,", "Atenção", JOptionPane.WARNING_MESSAGE);
                    }
