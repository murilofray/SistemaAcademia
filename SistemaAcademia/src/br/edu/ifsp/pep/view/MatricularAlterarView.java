 ...
 * @author vivi
 */
public class MatricularAlterarView extends javax.swing.JDialog {
    ...
    private Turma turma;
    private Turma turmaAntiga;

    /**
     * Creates new form TelaFuncionarioView
     */
    public MatricularAlterarView() {
        initComponents();
    ...
    protected void carregarCampos(Aluno aluno, Turma turma, Matricula matricula) {
        this.aluno = aluno;
        this.turmaAntiga = turma;
        this.matricula = matricula;
        tfNome.setText(aluno.getNome());
        tfTurma.setText(turma.getNome());
    }
    ...
    private void initComponents() {
        ...
        cbPesquisaTurma.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome:", "Valor:" }));
            ...
            if (!matriculado) {
                if (turma.getCapacidadeMaxima() >= turma.getQuantidadeMatriculados()) {
                    ...
                    try {
                        ...
                        turmaAntiga.setQuantidadeMatriculados(turmaAntiga.getQuantidadeMatriculados()-1);
                        turmaDAO.alterar(turmaAntiga);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MatricularAlterarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MatricularAlterarView().setVisible(true);
            }
        });
    }
