 ...
 * @author muril
 */
public class FuncionarioAlterarView extends javax.swing.JDialog {
    ...
    protected void carregarDados(Funcionario funcionarioParametro) {
        ...
        pfRepetirSenha.setText(funcionario.getSenha());
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(pfRepetirSenha, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(cbCargo, javax.swing.GroupLayout.Alignment.LEADING, 0, 177, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(309, 309, 309)
                        .addComponent(bIcon, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addComponent(bIcon, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel1)
                                    ...
                                    if (login.length() > 3 && login.length() <= 20) {
                                        if (senha.length() > 3 && senha.length() <= 15) {
                                            if (senha.equals(senhaRepetida)) {
                                                ...
                                                if (cpf.equals(funcionario.getCpf()) || funcionarios.isEmpty()) {
                                                    if (login.equals(login) || funcionarioDAO.findByLogin(login).isEmpty()) {
                                                        funcionario.setNome(nome);
                                                        funcionario.setCargo((String) cbCargo.getSelectedItem());
                                                        funcionario.setCpf(cpf);
                                                        funcionario.setDataNascimento(dData.getDate());
                                            ...
                                            JOptionPane.showMessageDialog(null, "Informe pelo menos 4 caracteres na senha e no maximo 15 caracteres na senha.", "Atenção", JOptionPane.WARNING_MESSAGE);
                                        }
                                    } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioAlterarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
