...
public class FuncionarioView extends javax.swing.JDialog {
    ...
    private List<Funcionario> funcionarios = funcionarioDAO.findAll();
    ...
    private void atualizarTabela() {
        ...
        for (Funcionario funcionarioo : funcionarios) {
            modelo.addRow(new Object[]{funcionarioo.getId(), funcionarioo.getNome(), funcionarioo.getCpf(), funcionarioo.getCargo(), funcionarioo.getSexo()});
        }
    }
    ...
    private void initComponents() {
        ...
        bIcone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifsp/pep/imagens/id-card.png"))); // NOI18N
        bIcone.setBorder(null);
        bIcone.setBorderPainted(false);
        bIcone.setContentAreaFilled(false);
        bIcone.setDefaultCapable(false);

        cbPesquisa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome:", "Id:", "Sexo:", "Cpf:", "Cargo:" }));
    ...
    private void bAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAlterarActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            FuncionarioAlterarView funcionarioAlterarView = new FuncionarioAlterarView();
            funcionario = this.funcionarios.get(jTable1.getSelectedRow());
            funcionarioAlterarView.carregarDados(funcionario);
            funcionarioAlterarView.setVisible(true);
            this.funcionarios = funcionarioDAO.findAll();
            atualizarTabela();
        } else {
    ...
    private void bVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVisualizarActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            FuncionarioVisualizarView funcionarioVisualizarView = new FuncionarioVisualizarView();
            funcionario = this.funcionarios.get(jTable1.getSelectedRow());
            funcionarioVisualizarView.carregarDados(funcionario);
            funcionarioVisualizarView.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "Selecione alguma linha para alterar!", "Atenção", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void bPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPesquisaActionPerformed
        ...
        if (cbPesquisa.getSelectedIndex() == 0) {
            funcionarios = funcionarioDAO.findByNome(tfPesquisa.getText());
        } else {
            if (cbPesquisa.getSelectedIndex() == 1) {
                if (tfPesquisa.getText().equals("")) {
                    ...
                    try {
                        ...
                        funcionarios = funcionarioDAO.findById(id);
                ...
                if (cbPesquisa.getSelectedIndex() == 2) {
                    funcionarios = funcionarioDAO.findBySexo(tfPesquisa.getText());
                } else {
                    if (cbPesquisa.getSelectedIndex() == 3) {
                        funcionarios = funcionarioDAO.findByCpf(tfPesquisa.getText());
                    } else {
                        funcionarios = funcionarioDAO.findByCargo(tfPesquisa.getText());
                    }
                }
            }
        }
    ...
    private void bExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExcluirActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            ...
            if (JOptionPane.showOptionDialog(null, "Ao excluir o funcionario todas as informações pessoais serão excluidas, Clique em confirmar para continuar.", "Atenção", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]) == 0) {
